...
export default function Complaints() {
	...
	const getPendingComplaints = async () => {
		const res = await fetch(`/citizen/complaintsss/Pending`, {
			method: "GET",
			headers: {
				"Content-Type": "application/json",
			},
	...
	const getReviewedComplaints = async () => {
		const res = await fetch(`/citizen/complaintss/Reviewed`, {
			method: "GET",
			headers: {
				"Content-Type": "application/json",
			},
	...
	const getUnderInvestigation = async () => {
		const res = await fetch(`/citizen/complaints/ForInvestigation`, {
			method: "GET",
			headers: {
				"Content-Type": "application/json",
			},
